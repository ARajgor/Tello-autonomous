...
This project is developed in 2021 and since then it's been not updated. 
currently I'm working on some other projects.

The approach I used may not efficient and better models are available now. 
You can do this entire project using google mediapipe library. 
it's very easy to use and efficient.

### About the drone

DJI Tello is a small drone with a camera. It can be controlled by a computer or a smartphone.
More information is [here](https://www.ryzerobotics.com/tello).
specification is [here](https://www.ryzerobotics.com/jp/tello/specs).
